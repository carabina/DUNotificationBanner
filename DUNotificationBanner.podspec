#
# Be sure to run `pod lib lint DUNotificationBanner.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of DUNotificationBanner.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/DUNotificationBanner.git', :tag => s.version.to_s }
